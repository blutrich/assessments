...
function CoachDashboard() {
  ...
  const [view, setView] = useState('athletes'); // ['athletes', 'cohort', 'analysis']
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            {(selectedUser || view === 'cohort') && (
              <button
                ...
                className="flex items-center px-3 py-2 text-sm font-medium text-gray-600 hover:text-indigo-600 bg-white rounded-lg shadow-sm border border-gray-200 hover:border-indigo-300 transition-colors"
              >
            ...
            <h1 className="text-2xl font-bold text-gray-900">
              {selectedUser ? 'Athlete Analysis' : view === 'cohort' ? 'Cohort Analysis' : 'Coach Dashboard'}
            </h1>
          </div>
          {!selectedUser && view === 'athletes' && (
            <button
          ...
          {view === 'cohort' && (
            <div className="flex items-center space-x-4">
              <span className="text-sm text-gray-500">Analyzing {usersData.length} athletes</span>
            </div>
          )}
        </div>
      </div>
      ...
      {selectedUser ? (
        ...
        <CohortAnalysis usersData={usersData} />
      ) : (
